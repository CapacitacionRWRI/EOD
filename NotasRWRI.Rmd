...
Chance aqui agregar seccion de dplyr 
...
##### Analisis de lo anterior (no se que proporcion usar para decidir si se puede estimar bien o no):
Viendo la lista de los de perfil sociodemografico:
```{r}
knitr::kable(PerfilSociodemograficoProporcionNAs, caption = 'Perfil Sociodemografico')
```


SOLO ME FALTA AQUI YA PONER EL ANALISIS DE LAS PROPORCIONES DE LOS NA Y CON LOS QUE SE DEBA CAMBIAR PONERLES LA MEDIANA O SI AVERIGUO COMO CON REGRESION CON EL ARTICULO QUE ME MANDASTE.
