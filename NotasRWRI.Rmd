...
#### Intro qplot (Chance cambiar los ejemplos que no se ve tan bien)
```{r}
library(ggplot2)
...
# edad
qplot(data=PerfilSociodemografico, x=edad)
# Viajes realizados por semana
qplot(data=PerfilSociodemografico, x=p5_4)
# Los dos pasados
qplot(data=PerfilSociodemografico, x=edad, y=p5_4)


# mappeando el tamaño
qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size = 3)


# setting el tamaño
qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size = I(3))



# mappeando el color
qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size = I(3), color = "blue")



# setting el color
qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size = I(3), color = I("blue"))

qplot(data=PerfilSociodemografico, x=edad, y=p5_4, geom="boxplot")



qplot(data=PerfilSociodemografico, x=edad, y=p5_4)

qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size=I(4))

qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size=I(4), color = I("red"))

qplot(data=PerfilSociodemografico, x=edad, y=p5_4, size=I(4), color = distrito)

```
ME SIGUE FALTANDO AGREGAR COSAS QUE TODAVIA NO HE MODIFICADO PARA EL EJERCICIO
